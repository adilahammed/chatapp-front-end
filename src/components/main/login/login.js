    ...
    <div className="registration-form form-body container-fluid ">
        ...
        <div className="social-media">
            ...
            <div className="social-icons">
                <a ><i className="icon-social-facebook" title="Facebook"></i></a>
                <a ><i className="icon-social-google" title="Google"></i></a>
                <a ><i className="icon-social-twitter" title="Twitter"></i></a>
            </div>
